...
sudo docker buildx build \
        ...
        -t herobone/opencv:full \
        -t herobone/opencv:latest \
        -t "herobone/opencv:full_${OPENCV_VERSION}" \
        --cache-from herobone/opencv:full_cache \
        --cache-to herobone/opencv:full_cache \
        --push \
    images/full
